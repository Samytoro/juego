document.addEventListener("DOMContentLoaded", function() {
    const words = [
      { word: "oso", image: "oso.jpg", audio: "oso.mp3" },
      { word: "suma", image: "suma.jpg", audio: "suma.mp3" },
      { word: "sapo", image: "sapo.jpg", audio: "sapo.mp3" },
      { word: "susi", image: "susi.jpg", audio: "susi.mp3" },
      { word: "sol", image: "sol.jpg", audio: "sol.mp3" },
      { word: "sopa", image: "sopa.jpg", audio: "sopa.mp3" },
      { word: "asea", image: "asea.jpg", audio: "asea.mp3" },
      { word: "sal", image: "sal.jpg", audio: "sal.mp3" },
      { word: "usa", image: "usa.jpg", audio: "usa.mp3" },
      { word: "seis", image: "seis.jpg", audio: "seis.mp3" },
    ];
